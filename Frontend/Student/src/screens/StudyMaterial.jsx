...
import { API_URL } from '../../services/default';

// Data for subjects
const subjects = [
  { id: '1', name: 'Subject Information', pdfUrl: `${API_URL.base}/download/java.pdf` },
  { id: '2', name: 'Paper Pattern', pdfUrl: `${API_URL.base}/download/os.pdf` },
  { id: '3', name: 'Notes', pdfUrl: `${API_URL.base}/download/dsa.pdf` },
];
